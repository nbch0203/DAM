...
public class ServidorSSL {
	public static void main(String[] args) {
		...
		// "123456": Es la CONTRASEÑA con la que se protegió el fichero 'almacen.jks' al
		// crearlo.
		// Si no coincide con la que pusiste en el comando keytool, el programa fallará
		// al arrancar.
		...
		try {
			...
			// A diferencia de los Sockets normales (new ServerSocket...), en SSL
			// necesitamos
			// una "Fábrica" (Factory) porque la configuración de seguridad es compleja.
			SSLServerSocketFactory sfact = (SSLServerSocketFactory) SSLServerSocketFactory.getDefault();

			// Usamos la fábrica para crear el socket. Hacemos casting (SSLServerSocket)
			// para
			...
			// PERO AQUÍ OCURRE LA MAGIA: En cuanto el cliente conecta, Java realiza
			// automáticamente
			// el "Handshake" (negociación de claves, envío de certificados, etc.) antes de
			// continuar.
			...
			// exactamente igual que siempre hemos usado. Java encripta/desencripta por
			// debajo de forma transparente.
