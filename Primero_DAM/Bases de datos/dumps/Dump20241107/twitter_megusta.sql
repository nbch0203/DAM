...
CREATE TABLE `megusta` (
  ...
  CONSTRAINT `megusta_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE,
  CONSTRAINT `megusta_ibfk_2` FOREIGN KEY (`id_tweet`) REFERENCES `tweet` (`id_tweet`) ON DELETE CASCADE
...
-- Dump completed on 2024-11-07 10:21:31
