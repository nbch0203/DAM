...
public class PruebadelRelojDigitalAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(pruebadelrelojdigital.PruebadelRelojDigitalApp.class).getContext().getResourceMap(PruebadelRelojDigitalAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(pruebadelrelojdigital.PruebadelRelojDigitalApp.class).getContext().getActionMap(PruebadelRelojDigitalAboutBox.class, this);
