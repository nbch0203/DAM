...
CREATE TABLE `seguidor` (
  ...
  CONSTRAINT `seguidor_ibfk_1` FOREIGN KEY (`id_seguidor`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE,
  CONSTRAINT `seguidor_ibfk_2` FOREIGN KEY (`id_seguido`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE
...
-- Dump completed on 2024-11-07 10:21:30
