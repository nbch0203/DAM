...
public class RelojDigitalBeanBeanInfo extends SimpleBeanInfo {
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_alarmaListener] = new EventSetDescriptor ( RelojDigital.RelojDigitalBean.class, "alarmaListener", RelojDigital.RelojDigitalBean.AlarmaListener.class, new String[] {"SuenaAlarma"}, "addAlarmaListener", "removeAlarmaListener" ); // NOI18N
