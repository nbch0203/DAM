...
CREATE TABLE `customer_audit` (
  `audit_id` smallint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `customer_audit_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`)
...
-- Dump completed on 2025-04-30 20:33:46
